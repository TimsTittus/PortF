        ...
        <div className="bg-nb-cream py-12 min-h-screen">
            <div className="container mx-auto max-w-7xl px-4">
                <div className="mb-16 text-center">
                    <h2 className="text-6xl md:text-8xl font-black uppercase tracking-tighter text-nb-black mb-6">
                        Gal<span className="text-nb-purple">lery</span>
                    </h2>

                    <p className="text-xl font-bold text-nb-black/70 max-w-3xl mx-auto italic">
                ...
                <div className="grid grid-cols-2 gap-6 sm:grid-cols-3 md:gap-10 xl:gap-12">
                    {[
                        ...
                        <div
                            key={idx}
                            className={`group relative flex h-64 items-end overflow-hidden border-4 border-nb-black shadow-nb-hard group ${item.span} md:h-96 hover:-translate-x-1 hover:-translate-y-1 transition-all active:shadow-none active:translate-x-1 active:translate-y-1`}
                        >
                            <img
                                src={item.src}
                                loading="lazy"
