    ...
    <div className="container mx-auto max-w-7xl">
      ...
      <section className="min-h-[80vh] flex flex-col justify-center pt-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center py-12">
          <div className="lg:col-span-8 space-y-8">
            ...
            <h1 className="text-5xl sm:text-7xl md:text-8xl font-black tracking-tighter text-nb-black uppercase leading-[0.9]">
              Tims <br />
              <span className="text-nb-purple drop-shadow-[4px_4px_0px_#000]">Tittus</span>
            </h1>
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-nb-black/80 tracking-tight">
              Engineering, CyberSecurity Student & <span className="bg-nb-green px-2 border-2 border-nb-black">Polymath</span>
            </h2>
            <p className="text-nb-black font-bold max-w-2xl mt-6 text-xl leading-relaxed">
            ...
            <div className="pt-8 flex flex-wrap gap-6">
              <Link to="/projects" className="group relative">
                ...
                <div className="relative px-8 py-4 bg-nb-purple border-4 border-nb-black text-nb-black font-black uppercase text-xl flex items-center gap-3 group-hover:-translate-x-1 group-hover:-translate-y-1 transition-all">
                  View my work
              ...
              <Link to="/contact" className="group relative">
                <div className="absolute inset-0 bg-nb-black translate-x-2 translate-y-2 group-hover:translate-x-1 group-hover:translate-y-1 transition-all"></div>
                <div className="relative px-8 py-4 bg-white border-4 border-nb-black text-nb-black font-black uppercase text-xl flex items-center gap-3 group-hover:-translate-x-1 group-hover:-translate-y-1 transition-all">
                  Get in touch
      ...
      <section className="py-24 border-t-4 border-nb-black">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div>
            <h2 className="text-5xl md:text-6xl font-black uppercase tracking-tighter text-nb-black mb-4">
              Featured <span className="text-nb-purple">Projects</span>
            </h2>
            <p className="text-xl font-bold text-nb-black/70 max-w-xl italic">Some of my recent work that defines my engineering journey.</p>
          </div>
          <Link to="/projects" className="group relative">
      ...
      <section className="py-24 border-t-4 border-nb-black">
        <div className="text-center mb-16">
          <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter text-nb-black mb-4">
            Skills & <span className="bg-nb-yellow px-4 border-4 border-nb-black shadow-nb-hard">Expertise</span>
          </h2>
          <p className="text-xl font-bold text-nb-black/70 italic mt-6">Technologies and disciplines I've mastered over the years.</p>
        </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
          {[
            ...
            >
              <div className="absolute inset-0 bg-nb-black translate-x-2 translate-y-2 group-hover:translate-x-1 group-hover:translate-y-1 transition-all"></div>
              <div className={`relative ${skill.color} border-4 border-nb-black p-8 text-center group-hover:-translate-x-1 group-hover:-translate-y-1 transition-all h-full flex items-center justify-center`}>
                <h3 className="text-2xl font-black uppercase tracking-tight text-nb-black">{skill.name}</h3>
              </div>
            </div>
          ))}
        </div>
